...
class _Gaz extends State<Gaz> {
  List<String> labelGaz = ['', '', ''];
  List<int> valGaz = [0, 0, 0];
  ...
  String espacementChiffre(int ch) {
    ...
    List<String> parts = [];
    int taille = numberString.length;

    for (int i = taille; i > 0; i -= 3) {
      int start = (i - 3) < 0 ? 0 : i - 3;
      parts.insert(0, numberString.substring(start, i));
    }
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    editNom(i);
                                    setState(() {
                                      nouveauNomTemp.text = labelGaz[i];
                                    });
                                  },
                                )
                              ],
                            ...
                            Text(
                              "${espacementChiffre(valGaz[i].toInt())} bbp",
                              style: TextStyle(
              ...
              TextButton(
                  onPressed: () {
                    if (nouveauNomTemp.text != "") {
                      setState(() {
                        labelGaz[index] = nouveauNomTemp.text;
                        BaseDeDonne.changerNom(
                            'capteurGaz', nouveauNomTemp.text, index + 1);
                        nouveauNomTemp.text = '';
                        Navigator.pop(context);
                      });
                    } else {
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: Image.asset("assets/images/ventB.png"),
          )
        ],
      ),
      body: Center(
